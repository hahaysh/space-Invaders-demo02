...
## 목숨·재도전 설계 (09-01 위임 승인, 09-02 미착수)

제품 기준은 PRD R06/R08/R13/R14/R17~R20이다. 이 절은 기존 즉시 lost 분기를 대체할 기술 결정이며 현재 코드가 이미 바뀌었다는 의미가 아니다.
...
TEST_PLAN의 09-02 절에서 이전 lost 기대값의 전환과 유지할 경계를 정의한다. UI·README의 현재 조작 안내는 실제 구현 시 함께 변경하며, 09-01에는 코드·검사·설치·실행을 하지 않는다.
