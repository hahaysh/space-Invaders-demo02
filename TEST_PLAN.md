...
## 08-02 난이도 검증 경로 (08-01 설계, 미실행)

08-01에서는 문서만 검토한다. 아래 검사는 08-02 별도 지시 후 구현하며 수치는 PRD 공통 수치표만 참조한다. 07-02의 실제 공개 완료는 [이슈 #7 근거](https://github.com/hahaysh/space-Invaders-demo02/issues/7#issuecomment-5659849823)이며 난이도 구현의 근거가 아니다.
